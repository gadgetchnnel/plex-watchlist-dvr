...
class DvrMixin:
    """ Mixin for Plex objects that can be in a DVR. """

    def airings(self):
        """ Return a list of :class:`~plexapi.media.Airing`
            objects for the airings for this item.
        """
        return self.findItems(self._data, media.Airing)
